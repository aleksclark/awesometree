...
impl TextElement {
    pub fn new(input: Entity<TextInput>) -> Self {
        Self {
            input,
            fg: rgba(0xcdd6f4ff),
            fg_placeholder: rgba(0x6c7086ff),
            cursor_color: rgba(0x89b4faff),
            selection_color: rgba(0x89b4fa40),
        }
    }
    ...
    pub fn fg_placeholder(mut self, color: Rgba) -> Self {
        self.fg_placeholder = color;
        self
    }

    pub fn cursor_color(mut self, color: Rgba) -> Self {
        self.cursor_color = color;
        self
    }

    pub fn selection_color(mut self, color: Rgba) -> Self {
...
impl Element for TextElement {
    ...
    fn prepaint(
        ...
        let (display_text, text_color): (SharedString, Hsla) = if content.is_empty() {
            (input.placeholder.clone(), self.fg_placeholder.into())
        } else {
            (content, self.fg.into())
        };
